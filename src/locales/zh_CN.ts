export default {
  ...
  AcConfig: {
    ...
    After_Contest_Start_Prefix: '开始后',
    AutoSubmit_Enable: '定时自动交卷',
    AutoSubmit_Time: '自动交卷时间',
    AutoSubmit_Force_All_Desc: '对全班学生强制交卷',
  },
  ScoreReport: {
  ...
  ConfigTemplate: {
    ...
    Current_Homework_Mode_Hint:
      '当前为作业模式，相关配置不匹配，你确定要覆盖吗？',
    Current_Contest_Mode_Hint:
      '当前为考试模式，相关配置不匹配，你确定要覆盖吗？',
