...
export const pythonCompleteOptions = [
  ...
  { label: 'True', type: 'keyword' },
  {
    ...
    children: [
      ...
      { label: 'fd', type: 'function' },
      { label: 'back', type: 'function' },
      { label: 'bk', type: 'function' },
      { label: 'backward', type: 'function' },
      { label: 'right', type: 'function' },
      { label: 'rt', type: 'function' },
      { label: 'left', type: 'function' },
      { label: 'lt', type: 'function' },
      { label: 'goto', type: 'function' },
      { label: 'setpos', type: 'function' },
      { label: 'setposition', type: 'function' },
      { label: 'teleport', type: 'function' },
      { label: 'setx', type: 'function' },
      { label: 'sety', type: 'function' },
      { label: 'setheading', type: 'function' },
      { label: 'seth', type: 'function' },
      { label: 'home', type: 'function' },
      { label: 'circle', type: 'function' },
      { label: 'dot', type: 'function' },
      { label: 'stamp', type: 'function' },
      { label: 'clearstamp', type: 'function' },
      { label: 'clearstamps', type: 'function' },
      { label: 'undo', type: 'function' },
      { label: 'speed', type: 'function' },
      { label: 'position', type: 'function' },
      { label: 'pos', type: 'function' },
      { label: 'towards', type: 'function' },
      { label: 'xcor', type: 'function' },
      { label: 'ycor', type: 'function' },
      { label: 'heading', type: 'function' },
      { label: 'distance', type: 'function' },
      { label: 'degrees', type: 'function' },
      { label: 'radians', type: 'function' },
      { label: 'pendown', type: 'function' },
      { label: 'pd', type: 'function' },
      { label: 'down', type: 'function' },
      { label: 'penup', type: 'function' },
      { label: 'pu', type: 'function' },
      { label: 'up', type: 'function' },
      { label: 'pensize', type: 'function' },
      { label: 'width', type: 'function' },
      { label: 'pen', type: 'function' },
      { label: 'isdown', type: 'function' },
      { label: 'pencolor', type: 'function' },
      { label: 'fillcolor', type: 'function' },
      { label: 'color', type: 'function' },
      { label: 'filling', type: 'function' },
      { label: 'begin_fill', type: 'function' },
      { label: 'end_fill', type: 'function' },
      { label: 'reset', type: 'function' },
      { label: 'clear', type: 'function' },
      { label: 'write', type: 'function' },
      { label: 'hideturtle', type: 'function' },
      { label: 'ht', type: 'function' },
      { label: 'st', type: 'function' },
      { label: 'isvisible', type: 'function' },
      { label: 'shape', type: 'function' },
      { label: 'resizemode', type: 'function' },
      { label: 'shapesize', type: 'function' },
      { label: 'turtlesize', type: 'function' },
      { label: 'shearfactor', type: 'function' },
      { label: 'tilt', type: 'function' },
      { label: 'settiltangle', type: 'function' },
      { label: 'tiltangle', type: 'function' },
      { label: 'shapetransform', type: 'function' },
      { label: 'get_shapepoly', type: 'function' },
      { label: 'onclick', type: 'function' },
      { label: 'onrelease', type: 'function' },
      { label: 'ondrag', type: 'function' },
      { label: 'begin_poly', type: 'function' },
      { label: 'end_poly', type: 'function' },
      { label: 'get_poly', type: 'function' },
      { label: 'clone', type: 'function' },
      { label: 'getturtle', type: 'function' },
      { label: 'getpen', type: 'function' },
      { label: 'getscreen', type: 'function' },
      { label: 'setundobuffer', type: 'function' },
      { label: 'undobufferentries', type: 'function' },
    ],
  },
