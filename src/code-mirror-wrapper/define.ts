...
export const pythonCompleteOptions = [
  ...
  { label: 'True', type: 'keyword' },
  {
    ...
    type: 'keyword',
    children: [
      { label: 'forward()', type: 'method' },
      { label: 'fd()', type: 'method' },
      { label: 'back()', type: 'method' },
      { label: 'bk()', type: 'method' },
      { label: 'backward()', type: 'method' },
      { label: 'right()', type: 'method' },
      { label: 'rt()', type: 'method' },
      { label: 'left()', type: 'method' },
      { label: 'lt()', type: 'method' },
      { label: 'goto()', type: 'method' },
      { label: 'setpos()', type: 'method' },
      { label: 'setposition()', type: 'method' },
      { label: 'teleport()', type: 'method' },
      { label: 'setx()', type: 'method' },
      { label: 'sety()', type: 'method' },
      { label: 'setheading()', type: 'method' },
      { label: 'seth()', type: 'method' },
      { label: 'home()', type: 'method' },
      { label: 'circle()', type: 'method' },
      { label: 'dot()', type: 'method' },
      { label: 'stamp()', type: 'method' },
      { label: 'clearstamp()', type: 'method' },
      { label: 'clearstamps()', type: 'method' },
      { label: 'undo()', type: 'method' },
      { label: 'speed()', type: 'method' },
      { label: 'position()', type: 'method' },
      { label: 'pos()', type: 'method' },
      { label: 'towards()', type: 'method' },
      { label: 'xcor()', type: 'method' },
      { label: 'ycor()', type: 'method' },
      { label: 'heading()', type: 'method' },
      { label: 'distance()', type: 'method' },
      { label: 'degrees()', type: 'method' },
      { label: 'radians()', type: 'method' },
      { label: 'pendown()', type: 'method' },
      { label: 'pd()', type: 'method' },
      { label: 'down()', type: 'method' },
      { label: 'penup()', type: 'method' },
      { label: 'pu()', type: 'method' },
      { label: 'up()', type: 'method' },
      { label: 'pensize()', type: 'method' },
      { label: 'width()', type: 'method' },
      { label: 'pen()', type: 'method' },
      { label: 'isdown()', type: 'method' },
      { label: 'pencolor()', type: 'method' },
      { label: 'fillcolor()', type: 'method' },
      { label: 'color()', type: 'method' },
      { label: 'filling()', type: 'method' },
      { label: 'begin_fill()', type: 'method' },
      { label: 'end_fill()', type: 'method' },
      { label: 'reset()', type: 'method' },
      { label: 'clear()', type: 'method' },
      { label: 'write()', type: 'method' },
      { label: 'hideturtle()', type: 'method' },
      { label: 'ht()', type: 'method' },
      { label: 'st()', type: 'method' },
      { label: 'isvisible()', type: 'method' },
      { label: 'shape()', type: 'method' },
      { label: 'resizemode()', type: 'method' },
      { label: 'shapesize()', type: 'method' },
      { label: 'turtlesize()', type: 'method' },
      { label: 'shearfactor()', type: 'method' },
      { label: 'tilt()', type: 'method' },
      { label: 'settiltangle()', type: 'method' },
      { label: 'tiltangle()', type: 'method' },
      { label: 'shapetransform()', type: 'method' },
      { label: 'get_shapepoly()', type: 'method' },
      { label: 'onclick()', type: 'method' },
      { label: 'onrelease()', type: 'method' },
      { label: 'ondrag()', type: 'method' },
      { label: 'begin_poly()', type: 'method' },
      { label: 'end_poly()', type: 'method' },
      { label: 'get_poly()', type: 'method' },
      { label: 'clone()', type: 'method' },
      { label: 'getturtle()', type: 'method' },
      { label: 'getpen()', type: 'method' },
      { label: 'getscreen()', type: 'method' },
      { label: 'setundobuffer()', type: 'method' },
      { label: 'undobufferentries()', type: 'method' },
    ],
  },
